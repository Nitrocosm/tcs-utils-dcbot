"""ChallengesCog — the .create_challenge admin command.

Hosts the role-creation flow that spawns the three roles for a new challenge
(badge, display badge, pingable) and slots them into their server categories.
"""
import logging
import re
...
# ── legacy / unused helpers (preserved for parity with pre-refactor code) ───
